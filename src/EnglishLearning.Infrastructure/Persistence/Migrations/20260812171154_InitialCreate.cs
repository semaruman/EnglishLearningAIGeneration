        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WordsReviewed = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedText = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordSetItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WordSetItems_WordSets_WordSetId",
                        column: x => x.WordSetId,
                        principalTable: "WordSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WordSetItems_Words_WordId",
                        column: x => x.WordId,
                        principalTable: "Words",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWords_NextReviewAt",
                table: "UserWords",
                column: "NextReviewAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordSetItems_WordId",
                table: "WordSetItems",
                column: "WordId");

            migrationBuilder.CreateIndex(
                name: "IX_WordSetItems_WordSetId_WordId",
                table: "WordSetItems",
                columns: new[] { "WordSetId", "WordId" },
                unique: true);
        }
