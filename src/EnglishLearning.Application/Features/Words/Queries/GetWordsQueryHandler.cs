...
public class GetWordsQueryHandler : IRequestHandler<GetWordsQuery, PagedResult<WordDto>>
{
    private readonly IWordRepository _wordRepository;

    public GetWordsQueryHandler(IWordRepository wordRepository)
    {
        _wordRepository = wordRepository;
    }

    public async Task<PagedResult<WordDto>> Handle(GetWordsQuery request, CancellationToken cancellationToken)
    {
